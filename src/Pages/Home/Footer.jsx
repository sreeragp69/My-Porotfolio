    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        <div className="footer--logo">
          <img className="footer--logo--img" src="./img/logo.png" alt="No img" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100019576928606"
            ...
            <li>
              <a
                href="https://www.instagram.com/s.r.e.e__rag/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/Sree_rag_p"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/sreerag-p/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made  by Sreerag</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
